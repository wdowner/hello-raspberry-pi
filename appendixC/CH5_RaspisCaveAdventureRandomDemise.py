...
def intro():
    ...
    print("""
    You are in medieval times, a time of stone castles, knights with swords,
...
demise1 = """Raspi sees a rock on the ground and picks it up. He feels a sharp
pinch and drops the rock.  Just then he realizes it wasn't a rock but a
poisonous spider as he collapses to the ground."""
demise2 = """Standing in the cave, Raspi sees a small rabbit approach him.
Raspi gets a bad feeling about this rabbit.  Suddenly, the rabbit attacks him,
biting his neck."""
demise3 = """Whoa, is that a piece of gold?  As Raspi walks over to it, he
doesn't see a hole in the floor.  Suddenly, he falls down the hole, never to
be heard from again."""
